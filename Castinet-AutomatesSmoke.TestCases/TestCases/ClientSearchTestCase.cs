...
{
    [TestClass]
    public class ClientSearchTestCase : TestBase
    {
        ...
        public void ClientSearchTest()
        {
            try
            {
                ...
                Assert.AreNotEqual(TestEnvironment.LoadJson().LastName.Count, WebDriverUtils.TextChecker(ClientSearchPageObjects.ResultCountText()));
